...
public class ComplexNumber { // the code is not my own and I used the code so I can move through the courses without doing
    // every exercise, I do what I need to do in order to understand and I move on. Also, I do this because I'm on a one month deadline :(
    // by the way the code is from "Eddie" on udemy, 
    private double real;
