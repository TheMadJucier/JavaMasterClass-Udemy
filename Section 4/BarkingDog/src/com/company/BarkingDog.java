package com.company;/*We have a dog that likes to bark.  We need to wake up if the dog is barking at night!
...
public class BarkingDog {
    ...
    public static boolean shouldWakeUp (boolean barking, int hourOfDay) {
        // boolean dogBarking = barking;
        // int hoursofday = hourOfDay;
        ...
        // } else if (!dogBarking){
        //     return false;
        // } else if (hoursofday < 23 && hoursofday > 8){
        //     return false;
