...
public class Main {
	...
	// write your code here
        ...
        int newScore =  calculateScore("New score is", 500);
        System.out.println("New Score is " + newScore);

        calculateScore(75);  // unique methods come from the data types if overloading
        calculateScore();
       double centimeters = calFeetAndInchesToCentimeters(6, 0);
        if (centimeters < 0.0){
            System.out.println("Invalid parameters"); // use -1 to check and see if it's working
        }
        calFeetAndInchesToCentimeters(7, 5);
        calFeetAndInchesToCentimeters(6, -10);
